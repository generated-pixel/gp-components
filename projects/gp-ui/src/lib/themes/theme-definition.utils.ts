...
function mapSemanticToComponentOverrides(definition: GpThemeDefinition): ComponentThemeOverrides {
  ...
  const formBackgroundLight = formField?.background?.light ?? resolveSurfaceColor(colorSchema?.light)
  ...
  setModeVar(themeSwitcherVars, 'light', 'themeSelectBackground', themeSwitcher?.select?.background?.light)
  setModeVar(themeSwitcherVars, 'dark', 'themeSelectBackground', themeSwitcher?.select?.background?.dark)
  ...
  setModeVar(themeSwitcherVars, 'light', 'themeSelectFocusBorder', themeSwitcher?.select?.focusBorder?.light)
  setModeVar(themeSwitcherVars, 'dark', 'themeSelectFocusBorder', themeSwitcher?.select?.focusBorder?.dark)
  setModeVar(themeSwitcherVars, 'light', 'themeSelectFocusRing', themeSwitcher?.select?.focusRing?.light)
  setModeVar(themeSwitcherVars, 'dark', 'themeSelectFocusRing', themeSwitcher?.select?.focusRing?.dark)
...
function mergeOverrides(...overrides: Array<ComponentThemeOverrides | undefined>): ComponentThemeOverrides {
...
function setBaseVar(vars: ComponentVarsDefinition, key: string, value: StyleValue | undefined): void {
...
function setModeVar(vars: ComponentVarsDefinition, mode: ModeKey, key: string, value: StyleValue | undefined): void {
  if (value === undefined || value === null) {
    return
  }
